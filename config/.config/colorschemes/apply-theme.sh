...
cp "$THEME_DIR/hypr/colors.lua" "$HOME/.config/hypr/colors/colors.lua" > /dev/null 2>&1
echo ""
...
case "$THEME" in everforest-dark|gruvbox-dark|catppuccin|tokyo-night|kanagawa|nord-darker|noir|e-ink|nightfox|rose-pine)
