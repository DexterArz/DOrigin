...
hl.animation({ leaf = "windowsIn",          enabled = true,  speed = 5, bezier = "Fluid", style = "slide top 75%" })
hl.animation({ leaf = "windowsOut",         enabled = true,  speed = 5, bezier = "Fluid",style =  "slide bottom 75%" })
...
hl.animation({ leaf = "workspacesIn",       enabled = true,  speed = 5, bezier = "Elegant", style = "slidefadevert 50%" })
hl.animation({ leaf = "workspacesOut",      enabled = true,  speed = 5, bezier = "Elegant", style = "slidefadevert 50%"  })
