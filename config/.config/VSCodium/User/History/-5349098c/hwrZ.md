...
```
*this is always performed from main/master branch
this basically lets you chose how will you want to bring togeather both the branch, 
keep changes of main/master branch , keep changes of other branch or keep both the changes*

### 11. Deleting the branch 
```
git branch -d <branch Name>
```
*once a branch has been mearged to main/master there is no longer need to keep that branch*
### 12. stashing 
```
git stash
```
*basically saving the changes to draft when changing branch so the changes you made a saved even if they are not commited*
#### to apply drafted stash 
##### use this command
```
git stash appply 
```
